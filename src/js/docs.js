...
function replaceBlockquote(el, regex, getImageAndColorByType) {
  ...
  if (type) {
    ...
    wrapper.classList =
      'mb-10 max-w-2xl mx-auto px-4 py-8 shadow-lg lg:flex lg:items-center'
...
function highlightSupportPolicyTable() {
  ...
  const table = document.querySelector(
    '.docs_main #support-policy ~ div table:first-of-type'
  )
  ...
  const oldTable = document.querySelector(
    '.docs_main #support-policy ~ table:first-of-type'
  )
